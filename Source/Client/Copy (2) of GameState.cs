    ...
    public class GameState
    {
        ...
        private void ShutDown()
        {
            ...
            if (this != null && this.Entity != null)
            {
               ...
               //this.Send(new Conquer_Online_Server.Network.GamePackets.Message("http://www.xtremetop100.com/in.php?site=1132311748", System.Drawing.Color.Yellow, 2105));
                Disconnected = true;
        ...
        public Dictionary<ushort, Spell> FirstRebornSpells(int fClass, int currentClass)
        {
            ...
            switch (fClass)
            {
                ...
                case 55:
                    if (currentClass == 51)
                    {
                        SafeAddSpell((ushort)Enums.SkillIDs.FatalStrike, new Spell(true) { ID = (ushort)Enums.SkillIDs.FatalStrike });
